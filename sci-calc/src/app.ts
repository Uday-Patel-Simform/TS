        ...
        switch (value) {
            ...
            case "1/x":
                display.textContent! = displayAns(
                    eval(String(1 / +display.textContent!))
                );
                break;
            case "|x|":
            ...
            case "∛x":
                display.textContent! = displayAns(
                    Math.pow(+display.textContent!, 1 / 3)
                );
                break;
            case "x3":
    ...
    if (Content.includes("^")) {
        ...
        if (contentLength == 2) {
            ...
            if (count > 1) {
                ...
                const n1: number = Number(Content.slice(0, Content.indexOf('%')));
                const n2: number = Number(Content.slice(Content.indexOf('%') + 1));
                if (n2) {
                    display.textContent! = "Invalid input format!!";
